...
export function truncatePrincipal(principal: Principal | string, length: number = 8): string {
...
export function principalsEqual(p1: Principal | undefined, p2: Principal | undefined): boolean {
