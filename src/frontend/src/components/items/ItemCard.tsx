...
export default function ItemCard({ item }: ItemCardProps) {
  ...
  const typeColors = {
    [ItemType.lost]: 'bg-red-500/10 text-red-700 dark:text-red-400 border-red-500/20',
    [ItemType.found]: 'bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border-emerald-500/20',
  };
